...
class Gene:
    ...
    def __init__(
        self, min_level, max_level, value, chance_to_mutate, chance_to_go_up, step
    ):
        """
    ...
    def get_attr(self, attr):
        ...
        if attr == "value":
            return self.value
        if attr == "chance_to_mutate":
            return self.chance_to_mutate
        if attr == "chance_to_go_up":
            return self.chance_to_go_up
        return self.step
    ...
    def set_attr_value(self, attr, value):
        if attr == "min_level":
            ...
            self.value = value
        elif attr == "chance_to_mutate":
            self.chance_to_mutate = value
        elif attr == "chance_to_go_up":
            self.chance_to_go_up = value
        else:
            self.step = value
