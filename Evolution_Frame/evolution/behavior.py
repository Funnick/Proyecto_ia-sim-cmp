...
class Rule:
    ...
    def __init__(
        self, name="unnamed", to_see=None, to_move=None, to_relevance=lambda agent: 0
    ):
        self.name = name
        self.to_see = to_see
...
class EatRule(Rule):
    ...
    def __init__(self, to_see=None, to_move=None, to_relevance=None):
        def see_food(agent, element):
            ...
            if isinstance(element, Food) and (self_diet == 1 or self_diet == 3):
                return True
            elif (
                not (element is agent)
                and isinstance(element, agent.__class__)
                and (
                    self_size - 2 >= element.genetic_code.get_gene("size").value
                    and self_diet > 1
                )
            ):
                return True
        ...
        def move_food(cell=None, new_cell=None, world=None, path=None, elements=None):
            return mean(
                [manhattan([new_cell[0], new_cell[1]], [i[0], i[1]]) for i in elements]
            )
        ...
        Rule.__init__(
            self, name="food", to_see=to_see, to_move=to_move, to_relevance=to_relevance
        )
...
class TreeRule(Rule):
    ...
    def __init__(self, to_see=None, to_move=None, to_relevance=None):
        def see_tree(agent, element):
            self_diet = agent.genetic_code.get_gene("diet").value
            if isinstance(element, Tree) and (self_diet == 1 or self_diet == 3):
                return True
        ...
        Rule.__init__(
            self, name="tree", to_see=to_see, to_move=to_move, to_relevance=to_relevance
        )
    ...
    def __init__(self, to_see=None, to_move=None, to_relevance=None):
        def see_enemies(agent, element):
            ...
            if (
                ...
                and isinstance(element, agent.__class__)
                and (
                    element.genetic_code.get_gene("size").value - 2 >= self_size
                    and element.genetic_code.get_gene("diet").value > 1
                )
            ):
                return True

        def move_enemies(
            cell=None, new_cell=None, world=None, path=None, elements=None
        ):
            return mean(
                [manhattan([new_cell[0], new_cell[1]], [i[0], i[1]]) for i in elements]
            )
    ...
    def __init__(self, to_see=None, to_move=None, to_relevance=None):
        def see_couples(agent, element):
            ...
            if (
                ...
                and (
                    self_repr == 2
                    and element.genetic_code.get_gene("reproduction").value == 2
...
class ElevationRule(Rule):
    ...
    def __init__(self):
        def move_elevation(cell, new_cell, world=None, path=None, elements=None):
            return abs(
                world.map[new_cell[0]][new_cell[1]].height
...
class VisitedRule(Rule):
    ...
    def __init__(self, to_see=None, to_move=None, to_relevance=None):
        def move_edges(cell=None, new_cell=None, world=None, path=None, elements=None):
            edges = [
                abs(new_cell[0] - (world.dimension_x - 1)),
